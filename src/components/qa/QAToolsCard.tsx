...
function QAToolsBody() {
  ...
  return (
    <PremiumCard className="space-y-4 border-warning/40">
      ...
      {/* Internal Developer Console (dev only, no app navigation entry) */}
      <div className="space-y-2">
        <p className="text-xs font-semibold text-muted-foreground">כלים פנימיים</p>
        <Link
          to="/dev"
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="block text-sm font-semibold">קונסולת מפתחים</span>
            <span className="block text-[11px] text-muted-foreground">
              נכסי דמויות וכלים פנימיים — סביבת פיתוח בלבד
            </span>
          </span>
        </Link>
      </div>
