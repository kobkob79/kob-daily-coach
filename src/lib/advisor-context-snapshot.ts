...
/** Aggregated over the same lookback window as the timeline - a single
 *  resting-heart-rate reading, not per-sample wearable_metrics rows (those
 *  stay out of Advisor context; the aggregate is what recovery needs). */
