...
const HE: Dict = {
  ...
  "coach.shift.day": "אתה במשמרת יום היום.",
  "coach.shift.night": "אתה במשמרת לילה היום — לישון קל וחלבון לפני.",
  "coach.shift.off": "יום חופש — הזדמנות מצוינת להתאמן.",
  ...
  "shift.subtitle": "אינטל 4-על / 4-חופש · משמרות 12 שעות",
  "shift.set": "הגדרת רוטציה",
  "shift.update": "עדכון נקודת עיגון",
  "shift.firstDay": "יום עבודה ראשון",
  "shift.starting": "משמרת התחלה",
  "shift.day12": "יום (12ש)",
  "shift.night12": "לילה (12ש)",
  "shift.save": "שמור לוח",
  "shift.pattern": "תבנית: 4 ימים במשמרת ההתחלה → 4 חופש → 4 הפוכה → 4 חופש, וחוזר חלילה.",
