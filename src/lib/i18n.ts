...
const HE: Dict = {
  ...
  // Templates & Session
  "templates.title": "תבניות אימון",
  "templates.subtitle": "בנה שגרות קבועות והתחל אימון בלחיצה.",
  "templates.new": "תבנית חדשה",
  "templates.empty": "אין עדיין תבניות. צור אחת כמו Full Body A, Push או Pull.",
  "templates.name": "שם התבנית",
  "templates.namePh": "לדוגמה: Full Body A",
  "templates.exercises": "תרגילים",
  "templates.addExercise": "הוסף תרגיל",
  ...
  "templates.moveUp": "העלה",
  "templates.moveDown": "הורד",
  "templates.remove": "הסר",
  "templates.start": "התחל אימון",
  "templates.pick": "בחר תבנית להתחיל",
  "templates.saved": "התבנית נשמרה",
  "workouts.start": "התחל אימון",
  "workouts.templates": "תבניות",
  "session.set": "סט {n} מתוך {total}",
  "session.previous": "הקודם",
  "session.next": "הבא",
  "session.finish": "סיים אימון",
  "session.save": "שמור סט",
  "session.done": "האימון הסתיים",
  "session.exerciseOf": "תרגיל {n} מתוך {total}",
  "session.upNext": "הבא בתור",
  "session.completed": "הושלם",
  "session.noTemplate": "התבנית ריקה — הוסף תרגילים תחילה.",
