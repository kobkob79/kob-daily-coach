-- Health Data Integrity PR 1 (Clean Rebuild)
-- 1. authenticated role can only insert source = 'manual' for health_metrics.
...
-- Add check constraint for manual entries safely
...
-- Ensure authenticated users have NO UPDATE privilege on health_metrics.
